...
templates = Jinja2Templates(directory="templates") #using templates for the view.

#defining  fast API to the app variable
app = FastAPI() 
...
# first destination 
@app.get("/")#That line shows the URL where your app is being served, in your local machine.
